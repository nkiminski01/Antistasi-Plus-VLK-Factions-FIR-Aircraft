...
["vehicleBasic", "UK3CB_TKM_I_YAVA"] call _fnc_saveToTemplate;
["vehicleLightUnarmed", "UK3CB_TKM_I_LR_Closed"] call _fnc_saveToTemplate;
["vehicleLightArmed", "UK3CB_TKM_I_Hilux_Dshkm"] call _fnc_saveToTemplate;
["vehicleTruck", "UK3CB_TKM_I_V3S_Open"] call _fnc_saveToTemplate;
["vehicleAT", "UK3CB_TKM_I_Hilux_Spg9"] call _fnc_saveToTemplate;
["vehicleAA", "UK3CB_TKM_I_V3S_Zu23"] call _fnc_saveToTemplate;

["vehicleBoat", "UK3CB_CHD_I_Fishing_Boat"] call _fnc_saveToTemplate;
["vehicleRepair", "UK3CB_TKM_I_V3S_Repair"] call _fnc_saveToTemplate;
...
["vehicleCivTruck", "UK3CB_TKC_C_Ural_Open"] call _fnc_saveToTemplate;
...
["staticMG", "UK3CB_TKM_I_DSHKM"] call _fnc_saveToTemplate;
["AIstaticAT", "UK3CB_TKM_I_SPG9"] call _fnc_saveToTemplate;
["AIstaticAA", "UK3CB_TKM_I_ZU23"] call _fnc_saveToTemplate;
["staticMortar", "UK3CB_TKM_I_2b14_82mm"] call _fnc_saveToTemplate;
...
["blackMarketStock", [
    ...
    ["pook_PRV13_base_IND", 1000, "STATICAA", {tierWar > 4 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_SA3_radar_base_IND", 1000, "STATICAA", {tierWar > 4 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_SA3_static_root_IND", 1000, "STATICAA", {tierWar > 4 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_BCP_root", 1000, "STATICAA", {tierWar > 5 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_MIM23_root", 1000, "STATICAA", {tierWar > 5 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_ANMPQ61_root", 1000, "STATICAA", {tierWar > 5 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_ANMPQ62_root", 1000, "STATICAA", {tierWar > 5 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_30N6E2_mast", 3000, "STATICAA", {tierWar > 6 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_64N6E_base", 3000, "STATICAA", {tierWar > 6 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_SA20_static_base", 3000, "STATICAA", {tierWar > 6 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_NASAMS_battery_BASE", 4000, "STATICAA", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["POOK_ANMPQ53_Base", 5000, "STATICAA", {tierWar > 8 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ["pook_MIM104_PAC2_Base", 5000, "STATICAA", {tierWar > 8 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count (milbases + airportsX) > 0}}],
    ...
    ["Tornado_AWS_ADV_IND", 20000, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["Tornado_AWS_ind", 22500, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_EA6B_Blank", 17500, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_F18C_Blank_Aggressor", 32500, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_FA18F_Blank", 35000, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_Su25SM3_Blank", 25000, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_F23A_Blank", 400000, "PLANE", {tierWar > 9 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_AV8B_NA_Blank", 25000, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_EA18G_Blank", 20000, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_F22_ENEMY_TYPE_A", 500000, "PLANE", {tierWar > 9 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_A10C_Blank", 27500, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_F15C_Blank", 32500, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_F15E_Blank", 35000, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_F14D_Blank", 27500, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_F2A_IMAS", 600000, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["FIR_F16C_Blank", 35000, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
    ["SAFP_mig29sm", 27500, "PLANE", {tierWar > 7 && {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}}],
